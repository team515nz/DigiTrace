// ═══════════════════════════════════════════════════════════════════════════
// DIGITRACE: FEATURES - Models, Alignment, Tools, Export
// ═══════════════════════════════════════════════════════════════════════════
...
async function addModelFromFile(file, color, unit = 'm') {
    try {
        if (typeof THREE === 'undefined') throw new Error('THREE.js library not loaded. Please refresh the page.');
