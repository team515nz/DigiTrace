// ═══════════════════════════════════════════════════════════════════════════
// DIGITRACE: CORE ENGINE - Three.js 3D Rendering & Scene Management
// ═══════════════════════════════════════════════════════════════════════════
...
function calculateGlobalBoundingBox() {
    ...
    models.forEach(model => { 
        if (model.visible) globalBoundingBox.union(new THREE.Box3().setFromObject(model.group)); 
    });
}
