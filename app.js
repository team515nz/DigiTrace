// ═══════════════════════════════════════════════════════════════════════════
// DIGITRACE: APPLICATION LAYER - UI, Storage, Loaders, I18n
// ═══════════════════════════════════════════════════════════════════════════

// ═ PART 1: FILE LOADERS (OBJ, STL, GLB/GLTF) ═════════════════════════════════
...
// ═ PART 3: SESSION & TRANSFORM PERSISTENCE ══════════════════════════════════
...
// Auto-save every 8 seconds + on before-unload
...
async function loadTranslations() {
    try {
        ...
        console.warn('Failed to load translations.json, using fallback');
        window.TRANSLATIONS = {};
    }
}
...
window.addEventListener('load', () => {
    ...
    // Initialize session restoration after all assets are loaded
    restoreFullSession();
    restoreAnchorFromStorage();
});
